...
import {
  ...
  LogOut, ChevronDown, Sparkles, Gem,
} from "lucide-react";
...
export function Navbar() {
  const { profile, tier, isPremium, isElite, isAdmin, signOut, loading } = useProfile();
      ...
      <div className="container flex h-16 items-center justify-between px-4">
        ...
        <div className="flex items-center gap-4">
          ...
          {pathname === "/dashboard" && profile && (
            <div className="hidden md:flex flex-col border-l border-border/50 pl-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-2 h-9 px-2">
                  ...
                  {isElite ? (
                    <Badge className="hidden sm:flex gap-1 text-[10px] px-1.5 py-0 bg-purple-500/15 text-purple-400 border-purple-500/30">
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                {!isElite && (
                  <DropdownMenuItem asChild>
                    <Link href="/pricing" className={tier === "premium" ? "text-purple-500" : "text-blue-500"}>
                      {tier === "premium" ? (
                        <><Gem className="mr-2 h-4 w-4" /> Upgrade to Elite</>
                      ) : (
